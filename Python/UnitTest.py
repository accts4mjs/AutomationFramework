...
# print(expected); print(result); ut_tdd(result, expected, test); exit(0)
...
expected = "Hello World!\nbasedir = .\nfilename = foo\nversion = 10\nstart = 20200130\nend = 20200131\n" \
    "remove = False\nfoo = None"
result = ut_call_python(f"{FILE_NAME} -tool SampleTool -basedir . -filename foo -version 10 -start 20200130 -end 20200131")
ut_tdd(result, expected, test)
